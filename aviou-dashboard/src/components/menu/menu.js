...
function Menu() {
  return (
    <div className="menu">
      <div className="aviou-logo">
        <svg id="aviou-logo-2" xmlns="http://www.w3.org/2000/svg" width="164.801" height="59.8" viewBox="0 0 164.801 59.8">
          <path id="Path_2" data-name="Path 2" d="M41,8.2l.9,2.4a44.5,44.5,0,0,1,16.8,0l.9-2.4a47.313,47.313,0,0,0-9.3-.9A40.772,40.772,0,0,0,41,8.2Z" fill="#4fc1e1" />
          <path id="Path_3" data-name="Path 3" d="M50.2,2.5A49.207,49.207,0,0,1,61.1,3.7L62,1.3A56.878,56.878,0,0,0,50.2,0,56.878,56.878,0,0,0,38.4,1.3l.9,2.3A55.963,55.963,0,0,1,50.2,2.5Z" fill="#4fc1e1" />
          <path id="Path_4" data-name="Path 4" d="M9.1,43.6H22.5L17.4,30c-.4-1.1-.9-2.5-1.5-4.4q-.75,2.4-1.5,4.5ZM23.4,46H8.2L2.9,59.2H0L15.1,21.5h1.7L31.6,59.2h-3Z" fill="#fff" />
          <path id="Path_5" data-name="Path 5" d="M62.8,21.6h2.9L51.6,59.2H49.3l-14-37.6h2.8l9.5,25.6C49,51.1,50,54,50.5,55.9a58.244,58.244,0,0,1,2-6Z" fill="#fff" />
          <rect id="Rectangle_108" data-name="Rectangle 108" width="2.6" height="37.6" transform="translate(77 21.6)" fill="#fff" />
          <path id="Path_6" data-name="Path 6" d="M95.4,40.4c0,5.4,1.2,9.5,3.6,12.5,2.4,2.9,5.8,4.4,10.3,4.4s8-1.5,10.4-4.4,3.6-7.1,3.6-12.5-1.2-9.6-3.6-12.5-5.8-4.3-10.3-4.3-7.9,1.5-10.3,4.4C96.6,30.9,95.4,35,95.4,40.4Zm30.7,0c0,6-1.5,10.7-4.5,14.2s-7.1,5.2-12.3,5.2S100,58.1,97,54.6s-4.5-8.2-4.5-14.2S94,29.7,97,26.3s7.1-5.2,12.3-5.2,9.4,1.7,12.3,5.2Q126.1,31.4,126.1,40.4Z" fill="#fff" />
          <path id="Path_7" data-name="Path 7" d="M164.8,21.6V46c0,4.3-1.3,7.7-3.8,10.1s-6,3.7-10.5,3.7c-4.4,0-7.8-1.2-10.2-3.7-2.4-2.4-3.7-5.8-3.7-10.2V21.6h2.6V46q0,5.4,3,8.4c2,2,4.8,3,8.5,3,3.6,0,6.4-1,8.3-3a11.028,11.028,0,0,0,3-8.2V21.6Z" fill="#fff" />
        </svg>
      </div>
        ...
        <div className="menu-el">
          <svg xmlns="http://www.w3.org/2000/svg" version="1.1" id="Layer_1" x="0px" y="0px" viewBox="0 0 24 24" fill="currentColor" className="header-icon__frontend-components-blocks-nav-css-Section-module" width="25" height="25" data-av-icon="true">
            <g fill="#FFFFFF">
              ...
              c0.4,0,0.8,0.3,0.8,0.8V6H5.2C4,6,3,7,3,8.2v12C3,20.7,3.3,21,3.8,21s0.8-0.3,0.8-0.8v-12c0-0.4,0.3-0.8,0.8-0.8h15
              c0.4,0,0.8,0.3,0.8,0.8V9H8.2C7,9,6,10,6,11.2v10.5C6,23,7,24,8.2,24h13.5c1.2,0,2.2-1,2.2-2.2V11.2C24,10.3,23.4,9.4,22.5,9.1z
              M22.5,21.8c0,0.4-0.3,0.8-0.8,0.8H8.2c-0.4,0-0.8-0.3-0.8-0.8V11.2c0-0.4,0.3-0.8,0.8-0.8h13.5c0.4,0,0.8,0.3,0.8,0.8V21.8z" fill="#FFFFFF"></path>
              <path d="M18.6,15.1l-5.8-2.9c-0.2-0.1-0.5-0.2-0.7-0.2c-0.9,0-1.6,0.7-1.6,1.6v5.8c0,0.2,0.1,0.5,0.2,0.7c0.2,0.4,0.5,0.7,0.9,0.8
              c0.2,0.1,0.3,0.1,0.5,0.1c0.2,0,0.5-0.1,0.7-0.2l5.8-2.9c0.3-0.2,0.6-0.4,0.7-0.7C19.7,16.4,19.4,15.5,18.6,15.1z M17.9,16.6
              l-5.8,2.9c0,0-0.1,0-0.2-0.1v-5.8c0-0.1,0-0.1,0.1-0.1c0,0,0,0,0,0l5.8,2.9C18,16.4,18,16.5,17.9,16.6z" fill="#FFFFFF"></path>
            </g>
          </svg>
          <h3>Media</h3>
        </div>
          ...
          <div className="support-icon">
            <svg viewBox="0 0 37.805 37.805" data-av-icon="true" >
              <g>
                ...
                <path d="M49.306,58.3a1.181,1.181,0,0,0,1.181-1.181V55.052a1.181,1.181,0,0,0-2.363,0v2.067A1.181,1.181,0,0,0,49.306,58.3Z" transform="translate(-35.13 -39.324)"></path>
                <path d="M85.488,57.119V55.052a1.181,1.181,0,0,0-2.363,0v2.067a1.181,1.181,0,0,0,2.363,0Z" transform="translate(-60.678 -39.324)"></path>
              </g>
            </svg>
          </div>
